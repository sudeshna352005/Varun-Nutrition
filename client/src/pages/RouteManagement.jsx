        ...
        <div className="md:col-span-1 space-y-8">
          ...
          <div className="bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-lg">
            ...
            <ul className="space-y-3">
              {routes.map(route => (
                <li key={route.id} className="flex items-center p-3 hover:bg-slate-800 rounded-xl transition-colors border border-transparent hover:border-slate-700 text-zinc-300">
